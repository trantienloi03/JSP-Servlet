                        ...
                        <div class="mt-5">
                            <div class="row">
                                <div class="col-md-6 col-12 mx-auto">
                                    <h2>Chỉnh sửa thông tin thể loại: ${loai.getMaLoai() }</h2> <hr>
                                    <span style="color: red;">${errors.Existed }</span>
                                    <form class="row" action="SaveEditCategoryController" method="Post">
                                    <input type="hidden" name="maloai" value="${loai.getMaLoai()}" class="form-control"/>
                                        <div class="mb-3 col-12 col-md-6">
                                          <label class="form-label">Tên Loại</label>
                                          <input type="text" name="tenloai" value="${loai.getTenLoai() }" class="form-control" required="required"/>
