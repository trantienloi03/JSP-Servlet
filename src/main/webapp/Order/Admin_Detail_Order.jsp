              ...
              <main>
			   <div class="container-fluid px-4">
			      ...
			      <ol class="breadcrumb mb-4">
			         ...
			         <li class="breadcrumb-item"><a href="ShowOrderController">Order</a></li>
			      ...
			      <div class="card shadow mb-4">
			         <div class="card-header d-flex justify-content-between align-items-center">
			            <h3 class="card-title mb-0">Chi tiết hóa đơn</h3>
			            <a href="#" class="btn btn-primary">
			               <i class="fas fa-plus"></i> Xác nhận
			            </a>
			            <a href="#" class="btn btn-primary">
			               <i class="fas fa-plus"></i> Từ chối
			            </a>
			         </div>
			         <div class="card-body">
